  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          height: '65%',
          background: 'linear-gradient(to top, rgba(6,10,20,0.88) 0%, rgba(6,10,20,0.4) 55%, transparent 100%)',
        }}
      />

      {/* Mid-screen floating labels */}
      <motion.div
      ...
      >
        <span className="text-[11px] text-white/25 tracking-[0.24em] uppercase">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 px-8 md:px-14 pb-14 md:pb-18 flex flex-col md:flex-row md:items-end md:justify-between gap-8">

        {/* Left — big headline with 3D tilt */}
        <motion.div
        ...
        >
          <p className="text-sm md:text-[15px] text-white/55 leading-relaxed mb-7">
